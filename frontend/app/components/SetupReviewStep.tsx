...
// notice a typo in it. Clone images need no row: they build on demand from each preset's
// Dockerfile once setup is done.
  ...
  return (
    <div className="space-y-4">
      <p className="text-sm text-slate-600 dark:text-slate-300">
        Review your configuration, then finish setup. The one-time subnet
        latches and the <code>rmng</code> network is ensured when you click
        Finish.
      </p>
