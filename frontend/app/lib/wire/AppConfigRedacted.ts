 ...
 */
export type AppConfigRedacted = { listen: ListenConfig, agentPort: number, dataDir: string, staticDir: string, monitors: Array<MonitorSpec>, proxmoxSshSet: boolean, proxmoxHostnamePrefix: string, linearKeysSet: LinearKeysSet, claude: ClaudeConfig, cloneAccounts: Array<CloneAccountRedacted>, template: TemplateConfig, };
