...
// The colour scheme and the escape-sequence encoders are shared with the native macOS viewer.
use viewer_core::terminal::{
    arrow, base_button, bold_bright, dark_theme, light_theme, mouse_report, resolve, Rgb3,
};
use gtk4::gdk;
use gtk4::gio;
use gtk4::glib;
